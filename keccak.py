...
# Source: https://github.com/mgoffin/keccak-python/blob/master/Keccak.py
...
# Original source file has been modified slightly (padding removed)
...
class Keccak:
    ...
    def Keccak(self,M,r=1024,c=576,n=1024,verbose=False):
        """Compute the Keccak[r,c,d] sponge function on padded message M
        ...
        #Check the inputs
        if (plen%r!=0):
            raise KeccakError.KeccakError('inputLength must be a multiple of r')
        if (r<0) or (r%8!=0):
